...
[Link Simplifier Profil Übersicht](https://simplifier.net/isip/isipcapabilitystatementbasisserver)

{{render:https://gematik.de/fhir/isip/v1/Basismodul/CapabilityStatement/server}}